  ...
  <Html>
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={paragraph}>
          Thank you for reaching out to Kortex support. We have received your
          support ticket.
        </Text>
        <Text style={paragraph}>
          Our support team is reviewing your request and will get back to you
          as soon as possible. You can view the status of your support tickets
